...
DROP TABLE IF EXISTS procedures_intermediate_0;
DROP TABLE IF EXISTS procedures_intermediate_1;
DROP TABLE IF EXISTS procedures_final;

CREATE TABLE procedures_intermediate_0
STORED AS PARQUET
AS
select 
...
CREATE TABLE procedures_intermediate_1
STORED AS PARQUET
AS
SELECT
...
FROM
	procedures_intermediate_0;

CREATE TABLE procedures_final
STORED AS PARQUET
AS
SELECT
	hospitalid as hospitalid,
